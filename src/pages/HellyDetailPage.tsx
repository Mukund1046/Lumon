...
const HellyDetailPage: React.FC = () => {
    ...
    <div className="w-full h-full overflow-hidden bg-wardrobe-dark helly-theme">
      ...
      <div className="employee-detail helly-theme" ref={containerRef}>
        ...
        <h1 className="page-title | title">
          Helly R. <span className="slideshow__title__offset | title__offset">MDR Refiner</span>
        </h1>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Helly2/Severance23.jpg"
                        alt="Helly R."
                        className="tile__img"
                      />
                    </figure>
                    <div className="tile__content">
                      <h2 className="tile__title | title title--medium">Helly <span className="title__offset title__offset--medium">R.</span></h2>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Helly3/Severance102.jpg"
                        alt="Helly R."
                        className="tile__img"
                      />
                    </figure>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Helly4/Severance127.jpg"
                        alt="Helly R."
                        className="tile__img"
                      />
                    </figure>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Helly1/Severance31.jpeg"
                        alt="Helly R."
                        className="tile__img"
                      />
                    </figure>
