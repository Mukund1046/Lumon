...
const IrvingDetailPage: React.FC = () => {
  ...
  return (
    <div className="w-full h-full overflow-hidden bg-wardrobe-dark irving-theme" style={{ maxWidth: '100vw', boxSizing: 'border-box' }}>
      <Navbar />

      <div className="employee-detail irving-theme" ref={containerRef}>
        {/* Background elements */}
        ...
        <h1 className="page-title | title">
          Irving Bailiff <span className="slideshow__title__offset | title__offset">MDR Refiner</span>
        </h1>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Irving2/Severance22.jpg"
                        alt="Irving Bailiff"
                        className="tile__img"
                      />
                    </figure>
                    <div className="tile__content">
                      <h2 className="tile__title | title title--medium">Irving <span className="title__offset title__offset--medium">Bailiff</span></h2>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Irving3/Severance63.jpg"
                        alt="Irving Bailiff"
                        className="tile__img"
                      />
                    </figure>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Irving4/Severance74.jpg"
                        alt="Irving Bailiff"
                        className="tile__img"
                      />
                    </figure>
                  ...
                  <a href="#">
                    <figure className="tile__fig">
                      <img
                        ...
                        data-hover="/assets/Irving1/Severance21.jpg"
                        alt="Irving Bailiff"
                        className="tile__img"
                      />
                    </figure>
